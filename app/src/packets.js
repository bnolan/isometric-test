...
(function() {
  ...
  define(['/app/components/threejs/build/three.js', '/app/src/utils.js', '/app/src/elements/box.js'], function(THREE_, utils, Box) {
    ...
    PacketUpdate = (function() {
      ...
      PacketUpdate.prototype.process = function(scene) {
        ...
        element.position = new THREE.Vector3(this.positionX, this.positionY, this.positionZ);
